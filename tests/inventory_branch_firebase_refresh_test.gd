...
class FakeFirebaseSync extends Node:
...
func _run() -> void:
	...
	_check(sync.refresh_calls.has("araguaina"), "Firebase não permaneceu ativo para a filial regional.")
	...
	if failures.is_empty():
		print("INVENTORY_BRANCH_FIREBASE_REFRESH_TEST: OK")
		quit(0)
		return
