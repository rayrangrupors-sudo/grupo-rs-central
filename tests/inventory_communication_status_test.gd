...
func _run() -> void:
	...
	var gps_within_limit := Status.classify(_sample("2026-08-26 11:59:00", "2026-08-26 11:47:00", 1, "-5.5", "-47.4"), {}, now_unix)
	_check(gps_within_limit.get("color_key") == "verde" and not bool(gps_within_limit.get("gps_issue")), "GPS com 12 minutos de atraso foi classificado incorretamente como defeito.")
	var gps_late := Status.classify(_sample("2026-08-26 11:59:00", "2026-08-26 09:58:59", 1, "-5.5", "-47.4"), {}, now_unix)
	_check(gps_late.get("color_key") == "roxo" and bool(gps_late.get("gps_issue")), "Servidor atualizado e GPS com mais de duas horas de atraso não ficou roxo.")
