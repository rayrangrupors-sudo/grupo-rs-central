...
- O BancoLocalSQL é a fonte do Estoque de Imperatriz, Araguaína, Açailândia e Marabá.
...
- Araguaína, Açailândia e Marabá são BancoLocalSQL-only: não criam polling ST310 nem
...
Cobertura offline: `inventory_branch_local_database_refresh_test.gd`,
